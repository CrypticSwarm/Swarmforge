...
- [Make targets](reference/make-targets.md) — the build, run, update, and stop families, how a container is named, the Ollama and test targets, and what each one accepts.
